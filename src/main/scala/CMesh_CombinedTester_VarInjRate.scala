...
class OpenSoC_CMesh_AXI_CombinedTester_VarInjRate(c: OpenSoC_CMesh_AXI, parms: Parameters, rate: Double, pattern: String, packetCountPerPort : Int, fragmentationFactor : Int) extends Tester(c) {
    ...
    for (i <- 0 until c.numPorts) {
        ...
        poke (c.io.AXI(i).AWID, 0)
        poke (c.io.AXI(i).AWADDR, 0)
        poke (c.io.AXI(i).AWLEN, 0)
        poke (c.io.AXI(i).AWSIZE, 6)
        poke (c.io.AXI(i).AWBURST, 0)
    ...
    expect(c.io.AXI(0).BID, 1)
    step(1) // 6
    expect(c.io.AXI(0).BRESP, 0)
    step(10)

    // Read to see if packet availible (Packet should be unavailible)
    println("**** Read Packet Avalibility AXI(0) (Unavalible) ****")
    ...
    // Read to see if packet availible (Packet should be unavailible)
    println("**** Read Packet Avalibility AXI(1) (Unavalible) ****")
    ...
    // Read to see if packet availible (Packet should be unavailible)
    println("**** Read Packet Avalibility AXI(3) (Unavalible) ****")
    ...
    poke (c.io.AXI(0).AWADDR, 0x1000000)
    poke (c.io.AXI(0).AWID, 3)
    poke (c.io.AXI(0).AWLEN, 3)
    poke (c.io.AXI(0).AWVALID, 1)
    step(1) // 3
    poke (c.io.AXI(0).WDATA, 20)
    poke (c.io.AXI(0).WVALID, 1)
    expect(c.io.AXI(0).AWREADY, 1)
    expect(c.io.AXI(0).WREADY, 0)
    step(1) // 2
    poke (c.io.AXI(0).AWVALID, 0)
    expect(c.io.AXI(0).AWREADY, 0)
    expect(c.io.AXI(0).WREADY, 1)
    step(1) // 5
    poke (c.io.AXI(0).WVALID, 0)
    step(1)
    poke (c.io.AXI(0).WDATA, 21)
    poke (c.io.AXI(0).WVALID, 1)
    step(1) // 2
    expect(c.io.AXI(0).WREADY, 1)
    poke (c.io.AXI(0).WDATA, 22)
    step(1) // 5
    expect(c.io.AXI(0).WREADY, 1)
    poke (c.io.AXI(0).WDATA, 23)
    step(1) // 5
    poke (c.io.AXI(0).WVALID, 0)
    expect(c.io.AXI(0).WREADY, 0)
    poke (c.io.AXI(0).BREADY, 1)
    expect(c.io.AXI(0).BVALID, 1)
    expect(c.io.AXI(0).BID, 3)
    step(1) // 6
    expect(c.io.AXI(0).BRESP, 0)
    step(5)
    step(10)
    ...
    expect(c.io.AXI(2).ARREADY, 1)
    expect(c.io.AXI(2).RVALID, 1)
    expect(c.io.AXI(2).RDATA, 4)
    expect(c.io.AXI(2).RID, 3)
    expect(c.io.AXI(2).RRESP, 0)
    step(1)
    poke(c.io.AXI(2).RREADY, 1)
    step(1)
    ...
    poke (c.io.AXI(2).ARADDR, 1)
    poke (c.io.AXI(2).ARVALID, 1)
    poke (c.io.AXI(2).ARLEN, 3)
    step(1)
    poke (c.io.AXI(2).ARVALID, 0)
    expect(c.io.AXI(2).ARREADY, 1)
    expect(c.io.AXI(2).RVALID, 1)
    expect(c.io.AXI(2).RDATA, 20)
    expect(c.io.AXI(2).RID, 3)
    expect(c.io.AXI(2).RRESP, 0)
    step(1)
    expect(c.io.AXI(2).ARREADY, 1)
    expect(c.io.AXI(2).RVALID, 1)
    expect(c.io.AXI(2).RDATA, 21)
    expect(c.io.AXI(2).RID, 3)
    expect(c.io.AXI(2).RRESP, 0)
    step(1)
    expect(c.io.AXI(2).ARREADY, 1)
    expect(c.io.AXI(2).RVALID, 1)
    expect(c.io.AXI(2).RDATA, 22)
    expect(c.io.AXI(2).RID, 3)
    expect(c.io.AXI(2).RRESP, 0)
    step(1)
    expect(c.io.AXI(2).ARREADY, 1)
    expect(c.io.AXI(2).RVALID, 1)
    expect(c.io.AXI(2).RDATA, 23)
    expect(c.io.AXI(2).RID, 3)
    expect(c.io.AXI(2).RRESP, 0)
    step(1)
    expect(c.io.AXI(2).RVALID, 0)
